# Non-flake compatibility wrapper for mfwolffe-packages
# This allows importing via fetchTarball without flakes enabled
  ...
  packages = {
    ...
    fortsh = mkFortranMakePackage {
      ...
      src = pkgs.fetchFromGitHub {
        ...
        repo = "fortsh";
        rev = "v0.10.0";
        hash = "sha256-KnEHcgNL0fQXUYzVwEtJbMtm+E0sVPffFqd/yacxDqg=";
      };
